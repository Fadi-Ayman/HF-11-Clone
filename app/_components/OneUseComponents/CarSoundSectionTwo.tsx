...
function CarSoundSectionTwo() {
  ...
  return (
    <div className="absolute top-1/2 right-0 md:right-[9%] transform -translate-x-1/2 -translate-y-1/2 text-white font-bold flex justify-between items-start flex-col h-[60dvh] tracking-tighter ring-0">
      {/* Content */}
