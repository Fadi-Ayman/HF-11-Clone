...
function CarSpecsSectionOne() {
  return (
    <motion.div
      ...
      className="lg:w-[25%] xl:w-[20%] w-[80%] absolute bottom-[2rem] lg:bottom-[1.4rem] bg-black mix-blend-difference  left-[50%] lg:left-[60%]  z-10 "
    >
      ...
      <div className="px-1">
        <div className="flex w-full text-white justify-between items-center text-2xl font-semibold border-b border-gray-600 py-3">
          <AnimatedTitle
            ...
            delay={3.6}
            endAnimationInOneSec={true}
            className=" text-white  text-2xl h-[24px] "
          />
          <p>Weight (LBS)</p>
        </div>
