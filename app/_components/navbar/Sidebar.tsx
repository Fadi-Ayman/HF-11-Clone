    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <motion.div
          ...
          exit={{ width: "0px" }}
          className="absolute  top-0 right-0 w-[100dvw] h-[100dvh] backdrop-blur-[3px] z-[50] overflow-hidden"
        >
          {/* sidebar */}
          ...
          <motion.div
            ...
            className="absolute top-0 right-0  h-[100dvh] bg-gray-200 border-s border-s-gray-300 z-[50] pt-[5rem] overflow-clip will-change-transform flex items-center flex-col justify-start gap-5 "
          >
            <CustomLink
